...
path = 'D:/4_jeonbuk university/Human/LSH/TOF_1/Source/'
mng = plt.get_current_fig_manager()
mng.frame.Maximize(True)
# path = 'D:/3_jeonbuk university/TOF_MR/LCH/TOF_1/'
normal = list()
set_v = 5
...
cut_off = np.percentile(whole_arr_f, 99.775)
...
plt.axvline(cut_off, color='red',label = 'x of percentile 99.775  ={:.3f}'.format(cut_off), linestyle='dashed', linewidth=1)
